...
import { getAppointmentsByPatient, getPrescriptionsByPatient } from '../data/dummyData';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      setTimeout(() => {
        ...
        const userPrescriptions = getPrescriptionsByPatient(user.id);
        setAppointments(userAppointments.slice(0, 3));
        setPrescriptions(userPrescriptions.slice(0, 3));
        setLoading(false);
      }, 500);
    };
    fetchData();
